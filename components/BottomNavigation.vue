...
<!-- TODO: create logic with isActive prop for BottomNavigationItems -->
  <SfBottomNavigation class="smartphone-only">
    ...
    <SfBottomNavigationItem data-cy="bottom-navigation-url_menu" icon="menu" size="15px" label="Menu"/>
    <SfBottomNavigationItem data-cy="bottom-navigation-url_wishlist" icon="heart" size="15px" label="Wishlist" @click="toggleWishlistSidebar"/>
    <SfBottomNavigationItem data-cy="bottom-navigation-url_account" icon="profile" size="15px" label="Account" @click="handleAccountClick"/>
