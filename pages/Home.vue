<template>
  <div id="home">
    ...
    <LazyHydrate when-visible>
      <SfCallToAction
        title="Subscribe to our SWEET Newsletter"
  ...
  data() {
    return {
      ...
      banners: [
        {
          slot: "banner-A",
          subtitle: "Production Assistance",
          title: "How can we help?",
          description:
            "It does not matter if this is your first production run or your final production run. Either way we are here to assist you whenever theres an issue.",
          buttonText: "Shop now",
          image: {
  ...
  .sf-hero-item {
    &:nth-child(even) {
      ...
      @include for-mobile {
        ...
        --hero-item-wrapper-padding: var(--spacer-sm)
          var(--spacer-sm) var(--spacer-sm) var(--spacer-2xl);
      }
    }
  }
}
